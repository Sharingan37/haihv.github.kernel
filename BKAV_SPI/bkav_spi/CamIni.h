...
#define	BIAS_CURRENT_GL			0x01		// BIAS Current   0x00 : 0.5mA / 0x01 : 1.0mA / 0x02 : 1.5mA / 0x03 : 2.0mA -- modified by ThangLMb
#define	BIAS_GL					0x80		// BIAS for 	GL(IRIS)
#define	OFFSET_GL				0x80		// OFFSET for	GL(IRIS)
#define	OPAMP_GL				0x01		// Iris VGA Gain 0x50 -- modified by ThangLMb
...
#if ( STM2_MODE_A == 1 ) || ( STM2_MODE_B == 1 )
	#define	INI_A_PC2	0x19			//set up resolution chanel A
